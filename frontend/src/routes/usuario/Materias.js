...
const Materias = () => {
    ...
    const subirReporte = async () => {
        await putReportesUnidad(auth.user.token, dataSelected).then((res) => {
            //console.log(res)
            ...
            {true ?
                <>
                    {Object.keys(materiaD).length !== 0 ?
                                                        ...
                                                        unidadesD[index] !== undefined ?
                                                            (
                                                                unidadesD[index].map((datos) => {
                                                                    if (datos.Reprobados !== "" && datos.Fecha_Entrega !== "") {
                                                                                ...
                                                                                <div className='materia-unidad-card'>
                                                                                    ...
                                                                                    <div className='card-body'>
                                                                                        ...
                                                                                        <div className='reprobados'>
                                                                                            <p>Indice de reprobados: {datos.Reprobados}%</p>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                        ...
                        :
                        (<></>)}
                    <Modal show={showModal} setShow={setShowModal} title={dataSelected.Nombre_Materia}>
                            ...
                            <div className='reprobados'>
                                <p>Indice de reprobados:
                                    <input
                                        ...
                                        min={"0"}
                                        max={"100"}
                                        value={dataSelected.Reprobados}></input>
                                </p>
                            </div>
                            <button
                                onClick={() => {
                                    if (dataSelected.Reprobados !== "" && dataSelected.Fecha_Entrega !== "") {
                                        setShowModal2(true);
                                        setShowModal(false);
                                    } else {
                    ...
                    <Modal show={showModal2} setShow={setShowModal2} title={"Datos Guardados"}>
                    ...
                    <Modal show={showModalError} setShow={setShowModalError} title={"Datos Incompletos"}>
                        <div className='Modal2'>
