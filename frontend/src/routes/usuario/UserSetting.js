      ...
      {!loading ? (
        <>
          <div className="containerUserSettings">
            ...
            >
              <div className="modal group" style={{ textAlign: "center" }}>
                <p>
                  <strong>Los datos se han actualizado con exito</strong>
                </p>
              </div>
            ...
            >
              <div className="modal group">
                <p>
                  <strong>
                    A ocurido un error con al intentar actualizar los datos{" "}
                    <br /> Intente mas tarde
                  </strong>
                </p>
              </div>
              <button onClick={() => setShowModalError(false)}>
                Confirmar
              </button>
            </Modal>
          </div>
