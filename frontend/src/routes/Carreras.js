...
const Materias = (props) => {
  ...
  const buscador = (event) => {
    var filtrados = carreraData.map((carrera) => {
      if (
        carrera.Nombre_Carrera.toLowerCase().includes(
  ...
  const pdfDownload = async () => {
    await pdfCarrera(auth.user.token, "", "AllCarrera")
  }
  return (
    <>
      {loading === false ? (
        <div className="containerMaterias">
          ...
          >
            <p>
              Realmente esta seguro que quiere eliminar la Carrera:{" "}
              <strong className="Resaltado">{nombre_Carrera}</strong>
            </p>
            <div className="Materias-Detalles buttons">
              <input
                type="submit"
          ...
          >
            <div className="modal group">
              ...
              <br />
              {ID_Carrera === datainput.id_carrera ? null : (
                <p>
                  ID de la carrera pasara de:{" "}
                  <strong className="Resaltado">{ID_Carrera}</strong> a{" "}
                  <strong className="Resaltado">{datainput.id_carrera}</strong>
                </p>
              )}
              {nombre_Carrera === datainput.carrera_nombre ? null : (
                <p>
                  Nombre de la carrera pasara de:{" "}
                  <strong className="Resaltado">{nombre_Carrera}</strong> a{" "}
                  <strong className="Resaltado">
                    {datainput.carrera_nombre}
                  </strong>
                </p>
              )}
            </div>
